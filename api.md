{
  "apiEndpoints": {
    ...
    "CreateUserGroup": {
      "description": "Creates a new user group. The groupArn is generated by the server and must not be sent by the client; it is returned in the response.",
      "request": {
        "method": "POST",
        "path": "/user-groups",
        "body": {
      ...
      "response": {
        "200": {
          "description": "The created user group (includes server-generated groupArn).",
          "body": "UserGroupRecord"
        }
      }
    },
